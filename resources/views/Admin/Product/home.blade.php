                                    ...
                                    <tr class="bg-white border-b dark:bg-stone-700 hover:bg-gray-100 dark:hover:bg-stone-600">
                                        ...
                                        <td class="px-6 py-4 flex">
                                            <div x-data="{ showDeleteModal: false }" class="flex space-x-4 mt-6">
                                                <a href="{{ route('admin.products.edit', ['id'=>$product->id]) }}" class="px-3 py-2 text-white bg-blue-700 hover:bg-blue-800 rounded-md shadow transition duration-200">
                                                ...
                                                <div
                                                    ...
                                                    <div class="bg-white rounded-lg p-6 shadow-lg w-96">
                                                        ...
                                                        <p class="text-sm text-gray-600 mt-4">Are you sure you want to delete this product? This action cannot be undone.</p>
