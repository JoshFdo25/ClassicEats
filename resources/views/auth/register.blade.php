<x-guest-layout>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-6">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <button type="button" id="toggle-password" class="absolute inset-y-0 right-3 flex items-center text-gray-500 dark:text-gray-400">
                    <svg id="eye-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5 text-gray-500 dark:text-stone-400">
        ...
        <div class="flex flex-col space-y-4 items-center">
            ...
            <!-- Login Link -->
            <a href="{{ route('login') }}" class="underline text-sm text-indigo-600 hover:text-indigo-800 dark:text-indigo-400 dark:hover:text-indigo-600">
